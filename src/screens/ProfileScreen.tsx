					...
					<div className="ml-6 flex-1">
						...
						<div className="mt-5 opacity-80 hover:opacity-100">
							...
							<button
								...
								className="bg-yellow-500 hover:bg-yellow-600 transition cursor-pointer duration-200 text-white py-4 px-5 text-lg font-semibold rounded-md w-full mt-6">
								Update Profile
							</button>
